...
$authformHTML =	"
	{{^form}}<div class='container'>
		<form action='login_hendler_mustache.php' method='POST' enctype='multipart/form-data'>
			<div class='form-group form-control-lg'>
				<label>Login</label>
...
$formHTML =	"
	{{#form}}<div class='container'>
		<form action='login_hendler_mustache.php' method='POST'>
...
$template = $headerHTML . $formHTML . $authfailHTML . $authformHTML . $bottomHTML;
...
if (isset( $_SESSION['auth']) and $_SESSION['auth'] == true)
 {// show admin UI
	$data = array('form' => true, 'fail' => false);
} elseif (isset( $_SESSION['auth']) and $_SESSION['auth'] == false){
	$data = array('form' => false, 'fail' => true);
} else {
	$data = array('form' => false, 'fail' => false);	
}
*/
$data = array('form' => (isset( $_SESSION['auth']) and $_SESSION['auth']), 'fail' => (isset( $_SESSION['auth']) and !$_SESSION['auth']));
