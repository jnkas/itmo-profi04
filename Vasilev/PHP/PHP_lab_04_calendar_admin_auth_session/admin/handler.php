<?php
    ...
    echo '<head><meta charset="utf-8"></head><body style="padding-top: 100px;font-size: 20px;">Данные для календаря направлены на сервер. Через 5 секунд Вы вернетесь на страницу admin</body>';
